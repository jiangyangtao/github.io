...
var options = {
  scaleColor: false,
    trackColor: '#e0e0e0',/*rgba(255,255,255,0.1)*/
    barColor: '#6ad7f1',
  lineWidth: 10,
  lineCap: 'butt',
  size: 142
...
window.addEventListener('DOMContentLoaded', function() {
  var charts = [];
  [].forEach.call(document.querySelectorAll('.oscar-chart'),  function(el) {
...
window.addEventListener('DOMContentLoaded', function() {
  var charts = [];
  [].forEach.call(document.querySelectorAll('.oscar-chart-new'),  function(el) {
